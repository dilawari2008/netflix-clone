...
const Auth = () => {
  ...
  // useCallback -> prevents recreation of function instances, thereby preventing unnecessary memory usage, re-renders in case function is passed as prop, reduced garbage collection for orphaned function instances, or inconsistency if the function is used as a dependency in useMemo or useEffect
